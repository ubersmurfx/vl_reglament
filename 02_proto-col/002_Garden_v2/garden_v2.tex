...
\title{Протокол для очного этапа \\ Хакатона:«Сбор урожая»}
...
\begin{tabularx}{\textwidth}{>{\raggedright}X c *{4}{>{\centering\arraybackslash}p{1.3cm}}}
    ...
    \midrule
    Распознан заданный овощ/фрукт & \DetectPlod & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ \\
    Собран правильный овощ/фрукт & \CatchPlod & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$& $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$\\
    Распознан сгнивший овощ/фрукт & \RottenPlod & $\square$ & $\square$ & $\square$ & $\square$ \\
    Захвачен сгнивший овощ/фрукт & \CatchRottenPlod & $\square$ & $\square$ & $\square$ & $\square$ \\
    Перемещен сгнивший овощ/фрукт в контейнер & \StoredRottenPlod & $\square$ & $\square$ & $\square$ & $\square$ \\
    \midrule
    Собран неправильный овощ/фрукт  & \wrongPlod & $\square$ $\square$ & $\square$ $\square$ & $\square$ $\square$ & $\square$ $\square$ \\
    \midrule
