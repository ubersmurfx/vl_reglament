...
\title{Протокол для очного этапа \\ Хакатона:«Электролиз меди»}
...
\begin{tabularx}{\textwidth}{>{\raggedright}X c *{4}{>{\centering\arraybackslash}p{1.3cm}}}
    ...
    \midrule
    Обнаружено короткое замыкание №1 & \firstKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    Обнаружено короткое замыкание №2 & \secondKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    Обнаружено короткое замыкание №3 & \thirdKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    Нажата кнопка короткого замыкания №1 & \writeButtonsecondKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    Нажата кнопка короткого замыкания №2 & \writeButtonfirstKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    Нажата кнопка короткого замыкания №3 & \writeButtonthirdKZ & $\square$ & $\square$ & $\square$ & $\square$ \\
    \midrule
    Кнопка нажата неверно (максимум 3 раза за попытку)  & \WrongButton & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ & $\square$ $\square$ $\square$ \\
    \midrule
