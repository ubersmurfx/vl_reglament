...
\begin{tabularx}{\textwidth}{>{\raggedright}X c *{4}{>{\centering\arraybackslash}p{1.3cm}}}
    ...
    \midrule
    Посадка 1-й группы пассажиров & \boardingPassangersFirstZone & $\square$ & $\square$ & $\square$ & $\square$ \\
    Посадка 2-й группы пассажиров & \boardingPassangersSecondZone & $\square$ & $\square$ & $\square$ & $\square$ \\
    Доставка пассажиров в зону высадки & \passangersDelievery & $\square$ & $\square$ & $\square$ & $\square$ \\
    Соблюдение ПДД (движение по полосам) & \complianceTrafficRules & $\square$ & $\square$ & $\square$ & $\square$ \\
    \midrule
    Столкновение с общественным транспортом & \penaltyBusPoints & $\square$ & $\square$ & $\square$ & $\square$ \\
    \midrule
