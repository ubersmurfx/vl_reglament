...
\begin{itemize}
    \item Максимальное количество баллов на одном полигоне — \textbf{500}
    ...
    \fbox{%
        ...
        \vspace{8pt}
        $
        \text{Бонус за время} = (600 - T_1) \times \dfrac{T_2}{500} \times \dfrac{1}{6}
        $
        
        \smallskip
        \small
        где: $T_1$ — время выполнения (сек), $T_2$ — набранные баллы
        \vspace{8pt}
        \end{minipage}%
    }
    \end{center}
    
    \item Бонус за время \textbf{не превышает 100 баллов}, что составляет \textbf{20\%} от максимального количества баллов полигона
    \item Максимальное количество баллов за первый и второй выбранный полигон составляет
    \begin{itemize}
        \item Первый полигон: $S_1 = 500 + \text{бонус за время}$ (макс. 600 баллов)
        \item Второй полигон: $S_2 = 500 + \text{бонус за время}$ (макс. 600 баллов)
    \end{itemize}
\end{itemize}
...
\fbox{%
    ...
    \vspace{8pt}
    $
    \text{Итоговый балл} = S_1 + S_2
    $
    
    \smallskip
    \small
    где: $S_1$ — баллы за первый выбранный полигон, $S_2$ — баллы за второй выбранный полигон
    \vspace{8pt}
    \end{minipage}%
}
\end{center}
