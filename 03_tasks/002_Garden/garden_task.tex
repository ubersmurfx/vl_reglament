...
\begin{itemize}
    ...
    \item[>>] Положение на полигоне центрального ящика для гнилых плодов будет опре-
деляться случайным образом перед попыткой.
...
плодов (из 10 возможных видов), включая 1 гнилой плод. Перечень собирае-
мых (сбиваемых) плодов становится известен участникам в 1-й день соревно-
ваний. Порядок размещения плодов в теплице будет изменен перед началом
попыток.
\end{itemize}
