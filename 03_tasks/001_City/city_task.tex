...
ком исходя из правил дорожного движения.
    \item[>>] Движение по полосам (колеса не пересекают линию разметки) засчитывается только в том случаем, если робот забрал хотя бы одних пассажиров и доехал до парковки (знак P).
